import type { BoardPoint, PlayerColor } from "./types";
...
export const CLOCKWISE_COLORS: PlayerColor[] = ["red", "blue", "green", "yellow"];
...
export const TRACK_COORDS: BoardPoint[] = [
  { x: 4, y: 10 },
  { x: 4, y: 9 },
  { x: 4, y: 8 },
  { x: 4, y: 7 },
...
export const HOME_COORDS: Record<PlayerColor, BoardPoint[]> = {
  red: [
    { x: 5, y: 9 },
    { x: 5, y: 8 },
    { x: 5, y: 7 },
...
export const BASE_COORDS: Record<PlayerColor, BoardPoint[]> = {
  blue: [
    { x: 1, y: 1 },
    { x: 2, y: 1 },
    { x: 1, y: 2 },
